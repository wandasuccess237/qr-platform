    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .link-card:hover {
            ...
            box-shadow: 0 10px 30px rgba(197, 151, 99, 0.4);
        }
        .link-card .icon {
            font-size: 2.5em;
            margin-bottom: 10px;
...
<body>
    <div class="container">
        ...
        <div class="subtitle">NOOAXIS Stratégie-Accompagnement & Wanda Success</div>
